...
export const OPTION_PRESETS = [
  { preset: 'automerge', label: 'Auto-merge', description: 'Auto-merge minor/patch updates' },
  { preset: 'schedule', label: 'Schedule', description: 'Scheduled updates (Mon 3am JST)' },
  { preset: 'security', label: 'Security', description: 'Prioritize security updates' },
  { preset: 'production', label: 'Production', description: 'Conservative settings' },
  { preset: 'monorepo', label: 'Monorepo', description: 'Monorepo-specific settings' },
];
